...
describe('Hunspell(..)', () => {
    ...
    it(`should successfully construct an object when two strings are given`, () => {
        new Hunspell(enUS.affix, enUS.dictionary)
    })

    it(`should successfully construct an object when a dictionary is given`, () => {
        new Hunspell({ aff: enUS.affix, dic: enUS.dictionary })
    })

    it(`should construct an object of type Hunspell`, () => {
...
describe('Hunspell#spell(word)', () => {
    let hunspell = new Hunspell(enUS.affix, enUS.dictionary);
...
describe('Hunspell#spellSync(word)', () => {
    let hunspell = new Hunspell(enUS.affix, enUS.dictionary)
    let hunspellNL = new Hunspell(nl.affix, nl.dictionary)
